...
- **Need Sendspin multi-room audio?** → You're in the right place!
- **Prefer the official firmware?** → Use [FutureProofHomes/Satellite1-ESPHome](https://github.com/FutureProofHomes/Satellite1-ESPHome)
