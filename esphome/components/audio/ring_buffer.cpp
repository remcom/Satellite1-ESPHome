...
namespace esphome {
namespace audio {
static const char *const TAG = "audio/ring_buffer";
...
size_t RingBuffer::write_without_replacement(const void *data, size_t len, TickType_t ticks_to_wait, bool write_partial) {
