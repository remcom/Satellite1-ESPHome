...
/// Outputs PCM audio data directly to an I2S DAC using the shared I2SAudioOut channel.
class I2SAudioSpeaker : public I2SAudioSpeakerBase {
 public:
  void dump_config() override;

  // Expose parent's string overload so external components that still pass
  // strings (e.g. older external_components) continue to compile.
  using I2SAudioBase::set_i2s_comm_fmt;
